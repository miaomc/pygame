...
class Missile(pygame.sprite.Sprite):
    def __init__(self, position, velocity, max_acceleration=0.028284, fuel=150):
        ...
        self.fuel = fuel  # 150
        self.max_acceleration = max_acceleration  # 0.28284
...
class HomingMissile(Missile):
    def __init__(self, position, velocity, max_acceleration_vertical=0.05414, max_acceleration_parallel=0.01414, fuel=250):
        ...
        self.max_acceleration = max_acceleration_parallel  # 0.01414
